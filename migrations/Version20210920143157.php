 ...
 */
final class Version20210920143157 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_chambres (category_id INT NOT NULL, chambres_id INT NOT NULL, INDEX IDX_81B3AD1912469DE2 (category_id), INDEX IDX_81B3AD198BEC3FB7 (chambres_id), PRIMARY KEY(category_id, chambres_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
